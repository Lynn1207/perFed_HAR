...
W_DIM = 599648 #l1: 2112; l2: 8288; l3: 74848, l4: 599648; l6: 615224
inner_iteration = 5
T_thresh = 10
...
def server_update():
    ...
    global W_avg1_1,W_avg2_1,W_avg3_1, W_avg3_2, W_avg4_1, W_avg4_2#, W_avg4_3, W_avg4_4, W_avg5_1, W_avg5_2, W_avg5_3, W_avg5_4, W_avg6_1, W_avg6_2, W_avg6_3, W_avg6_4
    # print(np.max(W))
            ...
            try:
                ...
                if mess_type == -1:
                    ...
                    if user_id[0]<=4 and user_id[0]>=2:
                        W_avg=np.concatenate((W_avg1_1, W_avg2_1,W_avg3_2,W_avg4_2))
                    else:
