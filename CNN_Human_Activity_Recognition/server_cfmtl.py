...
groups_l1=[{2: 0.184, 8: 0.184, 3: 0.131, 5: 0.131, 6: 0.131, 1: 0.105, 7: 0.078, 4: 0.052}] #[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#
W_l1=np.zeros((len(groups_l1),1664))

groups_l2=[{2: 0.2, 8: 0.171, 3: 0.142, 5: 0.142, 6: 0.142, 1: 0.114, 7: 0.085},{4: 1.0}]
W_l2=np.zeros((len(groups_l2),75424-1664))

groups_l3=[{2: 0.2, 8: 0.171, 3: 0.142, 5: 0.142, 6: 0.142, 1: 0.114, 7: 0.085},{4: 1.0}]
