...
groups_l2=[{7: 0.166, 5: 0.138, 6: 0.138, 1: 0.111, 3: 0.111, 2: 0.111, 4: 0.111, 8: 0.111}]
W_l2=np.zeros((len(groups_l2),14432-2112))

groups_l3=[{1: 0.2, 3: 0.125, 4: 0.125, 5: 0.125, 6: 0.125, 2: 0.1, 7: 0.1, 8: 0.1}]
W_l3=np.zeros((len(groups_l3),100832-14432))

groups_l4=[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]
