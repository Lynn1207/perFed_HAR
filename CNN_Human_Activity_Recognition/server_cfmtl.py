...
groups_l1=[{1: 0.162, 4: 0.162, 5: 0.162, 2: 0.139, 3: 0.139, 8: 0.139, 7: 0.093}]#[{2: 0.184, 8: 0.184, 3: 0.131, 5: 0.131, 6: 0.131, 1: 0.105, 7: 0.078, 4: 0.052}] #[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#
W_l1=np.zeros((len(groups_l1),1664))

groups_l2=[{5: 0.176, 3: 0.147, 8: 0.147, 7: 0.117, 2: 0.117, 6: 0.117, 1: 0.088, 4: 0.088}]
W_l2=np.zeros((len(groups_l2),75424-1664))

groups_l3=[{1: 0.333, 4: 0.333, 7: 0.333},{3: 0.238, 8: 0.238, 5: 0.19, 6: 0.19, 2: 0.142}]
