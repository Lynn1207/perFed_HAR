...
groups_l1=[{4: 0.214, 1: 0.178, 3: 0.178, 6: 0.178, 8: 0.178, 7: 0.071},{2: 0.5, 5: 0.5}]#[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#
W_l1=np.zeros((len(groups_l1),640))

groups_l2=[{4: 0.214, 1: 0.178, 3: 0.178, 6: 0.178, 8: 0.178, 7: 0.071},{2: 1.0},{5: 1.0}]
