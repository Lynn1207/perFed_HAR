...
groups_l1=[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#[{1: 0.142, 2: 0.142, 3: 0.142, 5: 0.142, 6: 0.142, 7: 0.142, 8: 0.142}, {4: 1.0}] #groups
W_l1=np.zeros((len(groups_l1),1664))

groups_l2=[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#[{1: 0.5, 7: 0.5},{2: 0.2, 3: 0.2, 5: 0.2, 6: 0.2, 8: 0.2},{4: 1.0}]
W_l2=np.zeros((len(groups_l2),75424-1664))

groups_l3=[{1:1.0},{2:1.0},{3:1.0},{4:1.0},{5:1.0},{6:1.0},{7:1.0},{8:1.0}]#[{1: 1.0}, {6: 0.266, 2: 0.2, 3: 0.2, 5: 0.2, 8: 0.133}, {4:1.0},{7:1.0}]
