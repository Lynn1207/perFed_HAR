...
def server_update():
    ...
    W_avg2_1=(W[0][6208:14432]+W[1][6208:14432]+W[4][6208:14432]+W[3][6208:14432]+W[5][6208:14432])/5.0
    W_avg2_2=W[2][6208:14432]
    '''
    W_avg3_1=(W[0][14432:125408]+W[1][14432:125408]+W[2][14432:125408]+W[3][14432:125408]+W[5][14432:125408])/5.0
    W_avg3_2=W[4][14432:125408]
    
    W_avg4_1=(W[0][125408:199328]+W[1][125408:199328]+W[2][125408:199328]+W[3][125408:199328]+W[5][125408:199328])/5.0
    W_avg4_2=W[4][125408:199328]
            ...
            try:
                ...
                if mess_type == -1:
                    ...
                    if user_id[0]==3 :
                        ...
                        W_avg=np.concatenate((W_avg1_1, W_avg2_1))#, W_avg2_1,W_avg3_1,W_avg4_1, W_avg5_3, W_avg6_3))
                    #print(out_i, user_id[0])
