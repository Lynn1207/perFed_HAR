...
W_DIM =2112#l1: 1664; l2: 52896; l3: 163872, l4: 213152; l5:776806
inner_iteration = 5
T_thresh = 10
...
def server_update():
    ...
    W_avg1_1=W[0, 0:2112]
    W_avg1_2=np.mean(W[1:8, 0:2112], axis = 0)
    '''
        ...
        while out_i<outer_iter:
            try:
                ...
                if mess_type == -1:
                    ...
                    if user_id[0]==1:
                        W_avg=W_avg1_1#np.concatenate((W_avg1_1, W_avg2_1, W_avg3_1, W_avg4_1))
                    else:
                        W_avg=W_avg1_2#np.concatenate((W_avg1_1, W_avg2_1, W_avg3_1, W_avg4_2))
