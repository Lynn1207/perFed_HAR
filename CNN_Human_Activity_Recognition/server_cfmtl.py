...
def server_update():
    ...
    W_avg1_2=np.mean([W[1:5][0:6208],W[6:12][0:6208]], axis = 0)
        ...
        while out_i<outer_iter:
            try:
                ...
                if mess_type == -1:
                    ...
                    if user_id[0]==1 or user_id[0]==6 :
                        W_avg=W_avg1_1#np.concatenate((W_avg1_2, W_avg2_2,W_avg3_2,W_avg4_3,W_avg5_3))
                    else:
                        W_avg=W_avg1_2#np.concatenate((W_avg1_1, W_avg2_1,W_avg3_1,W_avg4_2,W_avg5_2))
                    #print(out_i, user_id[0])
