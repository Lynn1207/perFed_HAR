...
cur_l=5
num_paras= 776806#l1: 1664; l2: 52896; l3: 163872, l4: 213152; l5: 213797
...
def inference(signals):
    ...
    with tf.variable_scope('conv1') as scope:
           ...
           conv = tf.nn.conv2d(signals, kernel, [1,6,3,1], padding='VALID', data_format='NHWC')
    ...
    pool2 = tf.nn.max_pool2d(conv2, ksize=[1,1,1, 1], strides=[1,2,1,1],padding='VALID',name='pool2')
          ...
          if cur_l>3:
            ...
            if cur_l>4:
              if var.op.name=="local4/weights5":
                var=tf.assign(var,tf.reshape(W_avg[773728:776800],[512, 6]))
                updated_paras.append(var)
              elif var.op.name=="local4/biases5":
                var=tf.assign(var, W_avg[776800:776806])
                updated_paras.append(var)
